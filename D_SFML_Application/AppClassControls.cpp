#include "AppClass.h"
//Keyboard
void SFMLApp::ProcessKeyboard(sf::Event a_event)
{
...
//Mouse
void SFMLApp::ProcessMouse(sf::Event a_event)
{
	m_bArcBall = false;
	m_bFPC = false;
...
void SFMLApp::ProcessMousePressed(sf::Event a_event)
{
...
void SFMLApp::ProcessMouseReleased(sf::Event a_event)
{
	if (a_event.mouseButton.button == sf::Mouse::Button::Left)
	{
	}
...
//Joystick
void SFMLApp::ProcessJoystick(sf::Event a_event)
{
}